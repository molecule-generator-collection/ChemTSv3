...
yaml_path_2 = "config/tuning/mol_opt_gbga.yaml"
...
def main():
    ...
    if args.enqueue:
        study.enqueue_trial({"c_1": 0.1, "best_rate_1": 0.5, "n_tries_1": 1, "c_2": 0.25, "best_rate_2": 0.9, "n_generations_until_lead": 200, "n_keys_to_pass": 5})
        study.enqueue_trial({"c_1": 0.1, "best_rate_1": 0.5, "n_tries_1": 1, "c_2": 0.15, "best_rate_2": 0.95, "n_generations_until_lead": 200, "n_keys_to_pass": 5})
