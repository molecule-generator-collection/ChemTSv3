...
class MCTS(Generator):
    ...
    def display_top_k_molecules(self, k: int=15, mols_per_row=5, legends: list[str]=["order","reward"], target: str="reward", size=(200, 200)):
        str2mol_func = self.root.sample_child().lang.sentence2mol
