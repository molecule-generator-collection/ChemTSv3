...
class MCTS():
  def __init__(self, edgepredictor: EdgePredictor, rewardfunc: Type[Reward] = LogP_reward, reward_conf: dict = None, rollout_limit=4096, print_output=True, verbose=False, name=None):
  ...
  def search(self, root: Node, policy: Type[Policy], policy_conf: dict = None, expansion_threshold=None, rollout_threshold=None, exhaust_backpropagate=False, dummy_reward=False, max_rollouts=None, time_limit=None, max_generations=None):
