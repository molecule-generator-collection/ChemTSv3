...
class BioT5PlusTransition(BlackBoxTransition):
    def __init__(self, target_objective: str, prompt_prefix: str=None, prompt_postfix: str=None, n_samples=2, logger: logging.Logger=None):
        ...
        self.prompt_prefix = prompt_prefix or "The molecule is obtained by performing a single reaction on: "
        self.prompt_postfix = prompt_postfix or ". The output molecule must be connected."
