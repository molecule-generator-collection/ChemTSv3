...
class ChatGPTTransition(LLMTransition):
    def __init__(self, prompt: str, model: str="gpt-4o-mini", api_key: str=None, api_key_path: str=None, use_web_search: bool=False, n_samples=1, filters: list[Filter]=None, logger: logging.Logger=None):
    ...
    def receive_response(self, prompt):
        ...
        if self.use_web_search:
            ...
            resp = client.responses.create(model=self.model, tools=tools, input=prompt)
        else:
